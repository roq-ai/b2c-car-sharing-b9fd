...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`B2C Car sharing v6`}</title>

        <meta
          name="description"
          content="Experience the ease of mobility with B2C Car Sharing v6. Book cars near you, managed efficiently by our dedicated operations staff."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the ease of mobility with B2C Car Sharing v6. Book cars near you, managed efficiently by our dedicated operations staff.`}
            </Text>
            <Box
